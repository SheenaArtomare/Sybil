...
#define	TREE_WIDTH			(90.0f)			// 頂点サイズ
#define	TREE_HEIGHT			(120.0f)			// 頂点サイズ
...
HRESULT InitTree(void)
{
	...
	// 木の設定
	SetTree(XMFLOAT3(40.0f, -5.0f, 60.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(220.0f, -5.0f, -30.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(-180.0f, -5.0f, -100.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(20.0f, -5.0f, 230.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(-30.0f, -5.0f, -210.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
...
HRESULT MakeVertexTree(void)
{
	...
	float fWidth = TREE_WIDTH;
	float fHeight = TREE_HEIGHT;
